...
const DogBreeds = () => {
  const breeds = [
    ...
    { name: 'Bulldog', description: 'Kind, courageous, and calm family companions.' },
    { name: 'Poodle', description: 'Highly intelligent, elegant, and active dogs.' },
  ];
        ...
        >
          <Card className="h-full flex flex-col">
            ...
            <CardContent className="flex-grow">
              <img src={`https://source.unsplash.com/400x300/?${breed.name.replace(' ', '-')}`} alt={breed.name} className="w-full h-48 object-cover rounded-md mb-4" />
...
const CareTips = () => {
  const tips = [
    ...
    { title: "Health", content: "Schedule regular check-ups with a veterinarian for vaccinations and health screenings." },
